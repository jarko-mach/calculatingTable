...
export const addPoint2 = () => {
    ...
    newDiv1.innerHTML = (!dataReport.point2.created) ?
        `<div class="point1_1"><textarea id="point2Text" rows="2" class="fieldToFill">${definitionPurposeOfResearch} ${foundResearchAddress}</textarea></div>`
        : `<div class="point1_1"><textarea id="point2Text" rows="2" class="fieldToFill">${dataReport.point2.text2}</textarea></div>`
